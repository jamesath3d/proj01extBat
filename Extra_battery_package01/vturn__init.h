...
/*
#define vturnOff3_TO_1()           {  _SetIN_(vturnOff3);  _SetIN_(vturnOff3x);  _SetIN_(vturnOff3y); }     // to 1
#define vturnOff3_TO_0()           { _SetOUT_(vturnOff3); _SetOUT_(vturnOff3x); _SetOUT_(vturnOff3y); }     // to 0
#define vturnOff3__init()          {   _Set0_(vturnOff3);   _Set0_(vturnOff3x);   _Set0_(vturnOff3y); }

#define vturnOff3_TO_1()           {                       _SetIN_(vturnOff3x);  _SetIN_(vturnOff3y); }     // to 1
#define vturnOff3_TO_0()           {                      _SetOUT_(vturnOff3x); _SetOUT_(vturnOff3y); }     // to 0
#define vturnOff3__init()          {                        _Set0_(vturnOff3x);   _Set0_(vturnOff3y); }
*/
#define vturnOff3_TO_1()           {                       _SetIN_(vturnOff3x);                       }     // to 1
#define vturnOff3_TO_0()           {                      _SetOUT_(vturnOff3x);                       }     // to 0
#define vturnOff3__init()          {                        _Set0_(vturnOff3x);                       }
...
*/
#define vturnOff4_TO_1()           {  _SetIN_(vturnOff4x);  _SetIN_(vturnOff4x);  _SetIN_(vturnOff4y); }     // to 1
#define vturnOff4_TO_0()           { _SetOUT_(vturnOff4x); _SetOUT_(vturnOff4x); _SetOUT_(vturnOff4y); }     // to 0
#define vturnOff4__init()          {   _Set0_(vturnOff4x);   _Set0_(vturnOff4x);   _Set0_(vturnOff4y); }
